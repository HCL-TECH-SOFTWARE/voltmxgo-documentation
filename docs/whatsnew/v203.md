...
- Updated [Configure an object service for Domino](../tutorials/adaptertutorial.md#configure-an-object-service-for-domino) procedure to include a step for completing the **Return documents from Bulk Update** text field.

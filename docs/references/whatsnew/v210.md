...
- Added support for [Volt Foundry Single Container Solution](../../tutorials/installdrapi.md#for-single-container-solution). 
...
- Added Hikes that can be used to learn concepts related to VoltFormula. For more information, see [Access VoltFormula Hikes](../../howto/VFHikes.md).

...
- Added details on how to represent view selection formulas in API. For more information, see [Representing view selection formulas in API](../../topicguides/selectfl.md).

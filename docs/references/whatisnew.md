...
##### Design Import
- Added a summernote component in the design import wizard.

### Improvements

##### Design Import

- The single scope is now compatible with DRAPI 1.0.7.
- When a pre-existing DRAPI service is used, the wizard may now manage multiple services in addition to the one generated by the wizard.

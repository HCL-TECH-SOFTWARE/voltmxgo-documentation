...
=== "All access scenario"
    ...
    **Domino/Domino REST API prerequisites**
    ...
    - You have configured a scope for your schema. For more information, see [Scope Management](https://opensource.hcltechsw.com/Domino-rest-api/references/usingwebui/scopeui.html "Link opens a new tab"){: target="_blank" rel="noopener noreferrer"}&nbsp;![link image](../assets/images/external-link.svg){: style="height:15px;width:15px"}.
...
4. Under **Provider Details**:
    ...
    6. Enter the name of the scope, configured in the OAuth application in the Domino REST API, in the **Scope** text box. 

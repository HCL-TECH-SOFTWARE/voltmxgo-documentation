...
The following tutorial shows you how to use VoltFormula in VoltMX Iris to convert formulas from OpenFormula and NotesFormula into VoltMX Go rosetta javascript.
...
2. Click on **Formula Language** window and enter a valid formula.
    ...
    !!! note "Note"  
        In Formula language  window, it has the abilty to detect the **Notes** and **Open** formula.
        - You must enter the **@** character before the formula in NotesFormula.
        - You must enter the **=** character before the formula in OpenFormula.
...
4. Add the code in the **Formula Language** window.
    ...
    !!! note "Notes"
        ...
        - If you don't know how to convert the javascript in voltmx 'rosetta.js' from **openFormula** and **NotesFormula**, you may use the Formula Language window to do so.

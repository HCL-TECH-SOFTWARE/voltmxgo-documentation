...
2. Click on **Formula Language** window and enter a valid formula.
    ...
    !!!notes ""
        ...
        - You must enter the **@** sign before the formula in NotesFormula.
        - You must enter the **=** sign before the formula in OpenFormula.
...
4. Add the code in the **Formula Language** window.
    !!!note "Remember"
        - **@** sign for *NoteFormula*
        - **=** sign for *openFormula*
        - You can the see the sysntax code or the intellisense for the formula that you choose.
        - If you don't know how to translate the javascript in voltmx `rosetta.js` from **openFormula** and **NotesFormula**, you can translate it by using the Formula Language window.

...
4. Create a new server connection.
    ...
    4. **(Optional)** If you configured the value of the `exposeNRPC` parameter to be `hostPort` during the [DRAPI Helm installation](../tutorials/downloadhelmchart.md) you are done.  If instead you specified `nodePort`:
